...
var reactHooksVisible = require('react-hooks-visible');
...
var isTagCanvasScripLoaded = false;
var Cloud = function Cloud(_ref) {
  var id = _ref.id,
      _ref$tagCanvasOptions = _ref.tagCanvasOptions,
      tagCanvasOptions = _ref$tagCanvasOptions === void 0 ? {} : _ref$tagCanvasOptions,
      _ref$tags = _ref.tags,
      tags = _ref$tags === void 0 ? [] : _ref$tags,
      _ref$canvasContainerS = _ref.canvasContainerStyle,
      canvasContainerStyle = _ref$canvasContainerS === void 0 ? {} : _ref$canvasContainerS,
      _ref$canvasHeight = _ref.canvasHeight,
      canvasHeight = _ref$canvasHeight === void 0 ? 1000 : _ref$canvasHeight,
      _ref$canvasWidth = _ref.canvasWidth,
      canvasWidth = _ref$canvasWidth === void 0 ? 1000 : _ref$canvasWidth,
      _ref$canvasStyle = _ref.canvasStyle,
      canvasStyle = _ref$canvasStyle === void 0 ? {} : _ref$canvasStyle,
      _ref$type = _ref.type,
  ...
  var _useVisible = reactHooksVisible.useVisible(function (vi) {
    return vi > 0.3;
  }),
      ref = _useVisible[0],
      visible = _useVisible[1];
  ...
  var getTag = function getTag(_ref2) {
    var id = _ref2.id,
        title = _ref2.title,
        href = _ref2.href,
        _ref2$imgWidth = _ref2.imgWidth,
        imgWidth = _ref2$imgWidth === void 0 ? 32 : _ref2$imgWidth,
        _ref2$imgHeight = _ref2.imgHeight,
        imgHeight = _ref2$imgHeight === void 0 ? 32 : _ref2$imgHeight,
        _ref2$imgSrc = _ref2.imgSrc,
        imgSrc = _ref2$imgSrc === void 0 ? '' : _ref2$imgSrc,
    ...
    }, type === 'img' ? React__default.createElement("img", {
      height: imgHeight,
      width: imgWidth,
      alt: "tag",
      src: imgSrc
...
var getTags = function getTags(_ref) {
  var tags = _ref.tags,
      bgColor = _ref.bgColor,
      size = _ref.size,
      fallbackColor = _ref.fallbackColor,
      _ref$minContrast = _ref.minContrast,
      minContrast = _ref$minContrast === void 0 ? 1 : _ref$minContrast;
  return tags.map(function (t) {
    var addHash = function addHash(color) {
      return color[0] === '#' ? color : "#" + color;
    };

    var icon = t.simpleIcon;
    var originalHex = addHash(icon.hex);
    var bgHex = addHash(bgColor);
    var isAccessibleColor = convertColors.hex2contrast(bgHex, originalHex) > minContrast;
    var rgb = isAccessibleColor ? convertColors.hex2rgb(originalHex) : convertColors.hex2rgb(fallbackColor);
...
var IconCloud = function IconCloud(_ref2) {
  var id = _ref2.id,
      _ref2$tagCanvasOption = _ref2.tagCanvasOptions,
      tagCanvasOptions = _ref2$tagCanvasOption === void 0 ? {} : _ref2$tagCanvasOption,
      _ref2$tags = _ref2.tags,
      tags = _ref2$tags === void 0 ? [] : _ref2$tags,
      _ref2$canvasContainer = _ref2.canvasContainerStyle,
      innerStyle = _ref2$canvasContainer === void 0 ? {} : _ref2$canvasContainer,
      _ref2$canvasHeight = _ref2.canvasHeight,
      canvasHeight = _ref2$canvasHeight === void 0 ? 1000 : _ref2$canvasHeight,
      _ref2$canvasWidth = _ref2.canvasWidth,
      canvasWidth = _ref2$canvasWidth === void 0 ? 1000 : _ref2$canvasWidth,
      _ref2$canvasStyle = _ref2.canvasStyle,
      canvasStyle = _ref2$canvasStyle === void 0 ? {} : _ref2$canvasStyle,
      fallbackHexColor = _ref2.fallbackHexColor,
      backgroundHexColor = _ref2.backgroundHexColor,
      size = _ref2.iconSize,
      _ref2$minContrastRati = _ref2.minContrastRatio,
      minContrast = _ref2$minContrastRati === void 0 ? 1 : _ref2$minContrastRati;
  var tags2 = getTags({
    tags: tags,
  ...
  return React__default.createElement(Cloud, {
    id: id,
...
//# sourceMappingURL=react-icon-cloud.cjs.development.js.map
