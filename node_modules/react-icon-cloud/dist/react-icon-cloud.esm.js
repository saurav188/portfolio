...
var Cloud = function Cloud(_ref) {
  ...
  var _useVisible = useVisible(function (vi) {
    return vi > 0.3;
  }),
      ref = _useVisible[0],
  ...
  var getTag = function getTag(_ref2) {
    ...
    }, type === 'img' ? React.createElement("img", {
      height: imgHeight,
      width: imgWidth,
      alt: "tag",
      src: imgSrc
...
var getTags = function getTags(_ref) {
  ...
  return tags.map(function (t) {
    ...
    var isAccessibleColor = hex2contrast(bgHex, originalHex) > minContrast;
    var rgb = isAccessibleColor ? hex2rgb(originalHex) : hex2rgb(fallbackColor);
...
export { Cloud, IconCloud, getTags };
